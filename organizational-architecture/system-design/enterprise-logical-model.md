...
* **Governed Relationships:** Location Inventory; Inventory Item indirectly through Location Inventory (no direct Location↔Inventory Item pairing exists in the Relational Model); Shipment, Replenishment, Shortage, Inventory Discrepancy, and Ticket directly.
...
* **Governed Relationships:**
  ...
  * Inventory Discrepancy, Shortage, Replenishment, Shipment, Corrective Action, SLA Event, Fulfillment Event — via the *Established* `related_ticket_id` pattern
